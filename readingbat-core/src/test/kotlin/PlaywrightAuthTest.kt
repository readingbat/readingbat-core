 ...
 *    ```
 *    TEST_BASE_URL=https://readingbat.com ./gradlew :readingbat-core:test --tests "PlaywrightAuthSetup"
 *    ```
 ...
 *    ```
 *    TEST_BASE_URL=https://readingbat.com ./gradlew :readingbat-core:test --tests "PlaywrightAuthTest"
 *    ```
 *
...
class PlaywrightAuthTest : StringSpec() {
  ...
  private val authStatePath: java.nio.file.Path
