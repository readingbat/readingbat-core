...
/**
 * WebSocket endpoint that broadcasts a server-side clock tick every second.
 *
 * Each connected client receives a [PingMessage] containing the elapsed time since
 * their connection was established and the current/max connection count. Primarily
 * used for diagnostics and demonstrating WebSocket connectivity.
 */
@Suppress("unused")
