...
import com.readingbat.common.ClassCode.Companion.newClassCode
...
import com.readingbat.common.FormFields.CHOICE_SOURCE_PARAM
import com.readingbat.common.FormFields.CLASS_CODE_CHOICE_PARAM
import com.readingbat.common.FormFields.CLASS_CODE_NAME_PARAM
import com.readingbat.common.FormFields.CLASS_DESC_PARAM
import com.readingbat.common.FormFields.CLASS_SUMMARY
import com.readingbat.common.FormFields.CREATE_CLASS
import com.readingbat.common.FormFields.DELETE_CLASS
import com.readingbat.common.FormFields.MAKE_ACTIVE_CLASS
...
import com.readingbat.common.FormFields.TEACHER_PREF
...
/**
 * Handles POST submissions from the teacher preferences page.
 *
 * Dispatches actions including creating and deleting classes, updating the active
 * teaching class, removing students from a class, and toggling between student
 * and teacher modes.
 */
internal object TeacherPrefsPost {
  ...
  fun RoutingContext.enableStudentMode(user: User?): PageResult {
    ...
    return PageResult.Redirect("$returnPath?$MSG=${msg.encode()}")
  }

  fun RoutingContext.enableTeacherMode(user: User?): PageResult {
    val returnPath = safeRedirectPath(queryParam(RETURN_PARAM, "/"))
    val msg =
      if (user.isValidUser()) {
