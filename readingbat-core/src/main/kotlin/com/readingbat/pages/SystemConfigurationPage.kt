...
import com.readingbat.server.ws.ChallengeWs.maxAnswerWsConnections
...
/**
 * Generates the system configuration display page at `/config`.
 *
 * Shows a read-only overview of server configuration, system properties, environment variables,
 * active user counts, content source paths, Prometheus agent details, and internal cache sizes.
 */
