...
import com.readingbat.common.Constants.PRISM
...
import com.readingbat.common.StaticFileNames.LIKE_COLOR_FILE
...
import com.readingbat.pages.js.CheckAnswersJs.checkAnswersScript
...
/**
 * Generates the individual challenge page at `/content/{lang}/{group}/{challenge}`.
 *
 * Displays the code snippet with syntax highlighting, answer input fields for each invocation,
 * like/dislike controls, and -- in teacher mode -- a real-time student progress dashboard
...
internal object ChallengePage {
  ...
  /** Fetches previously submitted answers for a challenge to pre-populate input fields. */
