...
/**
 * Generates the teacher preferences page at `/teacherprefs`.
 *
 * Allows teachers to create new classes, select an active class for monitoring,
 * view class enrollment details, and delete classes. Redirects unauthenticated
