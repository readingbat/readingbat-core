...
import com.readingbat.common.AuthRoutes.LOGOUT
...
/**
 * Generates the top-right header bar containing login/logout controls, navigation links
...
internal object HelpAndLogin {
  ...
  /** Renders the top-right help/login bar with user info, mode toggle, and OAuth modal for unauthenticated users. */
