...
import com.readingbat.common.Endpoints.studentSummaryEndpoint
...
import com.readingbat.server.LanguageName.Companion.EMPTY_LANGUAGE
...
/**
 * Generates the teacher's class summary page at `/classsummary`.
 *
 * Displays enrolled students with their per-challenge progress, using colored cells
 * to indicate correct, incorrect, and incomplete answers. When a specific challenge group
 * is selected, shows a detailed per-invocation breakdown updated in real time via WebSockets.
 */
