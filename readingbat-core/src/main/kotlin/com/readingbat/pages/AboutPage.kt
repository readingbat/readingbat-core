...
import com.readingbat.pages.PageUtils.tosPolicy
...
/**
 * Generates the "About ReadingBat" page at `/about`.
 *
 * Describes the project's origins, its relationship to CodingBat, and provides
 * links to create custom challenge repos and contact the team.
 */
        ...
        body {
          ...
          div(classes = TwClasses.INDENT_1EM) {
            ...
            p {
              ...
              a {
                href = "https://github.com/readingbat/readingbat-template/blob/master/README.md"
                +" here"
              }
              +"."
            }
