...
/**
 * Generates the admin data dashboard page at `/admin`.
 *
 * Provides administrative actions such as deleting all cached data, and displays
 * the contents of the content DSL cache, source cache, and directory cache.
