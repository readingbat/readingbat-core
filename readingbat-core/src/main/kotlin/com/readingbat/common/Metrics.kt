...
import com.pambrose.common.dsl.PrometheusDsl.summary
...
/**
 * Prometheus metrics definitions for monitoring the ReadingBat application.
 *
 * Tracks request counts by language and endpoint, WebSocket connection activity,
 * cache sizes, active user counts, and timing for content loading and challenge parsing.
 * All metrics are labeled with the agent launch ID for multi-server disambiguation.
 */
class Metrics {
  // /reset call count
