...
internal object PageUtils {
  ...
  fun HEAD.headDefault() {
    ...
    if (isProduction()) {
      ...
      // Development: use Tailwind CDN for instant class scanning (not for production use)
      script { src = "https://cdn.tailwindcss.com" }
      // CDN config with addBase plugin to restore element defaults that Tailwind
      // preflight resets. Mirrors tailwind-input.css @layer base rules.
      script {
        rawHtml(
          """
          tailwind.config = {
